...
const Home = () => {
  return (
    <div className="min-h-screen bg-[#111] text-gray-200">
      ...
      <div className=" container mx-auto px-4 flex flex-col items-center justify-center min-h-screen pt-16 pb-20">
        <div className="text-center max-w-4xl mx-auto mb-8 md:mb-12 pt-16 md:pt-0">
          ...
          <p className="text-gray-400 text-base md:text-lg lg:text-xl px-4">
            Last Moment Studies? We got you covered! Search our database and ace
            your exams
          </p>
        </div>
